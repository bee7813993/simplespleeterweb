<?php
// spleeter をインストールしたフォルダに「spleeter_2work.sh」ファイルを置きそのパスを指定する。
// Default spleeter_result.phpと同じパス

$spleeter_bat=dirname($_SERVER['SCRIPT_FILENAME'])."/spleeter_2work.sh";
